...
if($lastInsertId)
{
echo "<script>alert('Booking successfull kindly wait for Confirmation.');</script>";
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
              <label>To Date:</label>
              <input type="date" class="form-control" name="todate" placeholder="To Date"  min="<?php echo $todate; ?>" required>
            </div>
            <div class="form-group">
              <textarea rows="4" class="form-control" name="message" placeholder="Message" required>Book Car For Above Dates</textarea>
            </div>
...
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login For Book</a>
    ...
    <div class="divider"></div>
        ...
        <script>// Get the to date input element
...
// Set the min attribute of the to date input element to the next day's date
